...
#                        of executable (1/0)?
MODEL                = dual_motor
MODULES              = dual_motor_EXTI.c dual_motor_TIM.c dual_motor_USART.c main.c rtGetInf.c rtGetNaN.c rt_nonfinite.c stm32xxxx_it.c
MODULES_OBJ          = dual_motor_EXTI.obj dual_motor_TIM.obj dual_motor_USART.obj main.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj stm32xxxx_it.obj 
MAKEFILE             = dual_motor.mk
...
NUMST                = 1
NCSTATES             = 0
BUILDARGS            =  GENERATE_ASAP2=0 ISPROTECTINGMODEL=NOTPROTECTING OPTS="-DTID01EQ=0"
MULTITASKING         = 0
INTEGER_CODE         = 0
MAT_FILE             = 0
ONESTEPFCN           = 1
...
MODELLIB                  = 
MODELREF_LINK_LIBS        = 
MODELREF_LINK_RSPFILE     = dual_motor_ref.rsp
...
# Additional includes
ADD_INCLUDES = \
 -IC:/Users/tuziz/Desktop/STMPRO~1/MATLAB~3  -IC:/Users/tuziz/Desktop/STMPRO~1/MATLAB~3/dual_motor_stm32  -I$(MATLAB_ROOT)/extern/include  -I$(MATLAB_ROOT)/simulink/include  -I$(MATLAB_ROOT)/rtw/c/src  -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common  -I$(MATLAB_ROOT)/rtw/c/ert  -IC:/MATLAB/STM32-MAT/STM32/addSrc/inc 
