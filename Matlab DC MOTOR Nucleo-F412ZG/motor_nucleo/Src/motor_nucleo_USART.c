...
static uint8_t USART3_TxDataBuffer[512];
...
void USART3_Tx_Initialization(void)
{
  ...
  USART3_TxConf.buffSize = 512;
  USART3_TxConf.pTx_BuffStart = &USART3_TxDataBuffer[0];
  USART3_TxConf.pTx_BuffEnd = &USART3_TxDataBuffer[512];
